...
namespace winrt::impl
{
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_IncludedGroup(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)this;
            check_hresult(_winrt_abi_type->get_IncludedGroup(&value));
        }
    ...
    template <typename D> auto consume_Microsoft_Windows_Devices_Midi2_ClientPlugins_IMidiChannelEndpointListener<D>::IncludedGroup(winrt::Microsoft::Windows::Devices::Midi2::MidiGroup const& value) const
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->put_IncludedGroup(*(void**)(&value)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Devices_Midi2_ClientPlugins_IMidiChannelEndpointListener<D>::IncludedChannels() const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_IncludedChannels(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Devices_Midi2_ClientPlugins_IMidiChannelEndpointListener<D>::PreventCallingFurtherListeners() const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_PreventCallingFurtherListeners(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Devices_Midi2_ClientPlugins_IMidiChannelEndpointListener<D>::PreventCallingFurtherListeners(bool value) const
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->put_PreventCallingFurtherListeners(value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Devices_Midi2_ClientPlugins_IMidiChannelEndpointListener<D>::PreventFiringMainMessageReceivedEvent() const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_PreventFiringMainMessageReceivedEvent(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Devices_Midi2_ClientPlugins_IMidiChannelEndpointListener<D>::PreventFiringMainMessageReceivedEvent(bool value) const
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->put_PreventFiringMainMessageReceivedEvent(value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiChannelEndpointListener>**)this;
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiGroupEndpointListener>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiGroupEndpointListener, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiGroupEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_IncludedGroups(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiGroupEndpointListener>**)this;
            check_hresult(_winrt_abi_type->get_IncludedGroups(&value));
        }
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiMessageTypeEndpointListener>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiMessageTypeEndpointListener, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiMessageTypeEndpointListener>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_IncludedMessageTypes(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Devices::Midi2::ClientPlugins::IMidiMessageTypeEndpointListener>**)this;
            check_hresult(_winrt_abi_type->get_IncludedMessageTypes(&value));
        }
