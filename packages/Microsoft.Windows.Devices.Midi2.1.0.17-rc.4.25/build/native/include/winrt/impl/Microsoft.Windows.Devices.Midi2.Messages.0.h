...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::Devices::Midi2::Messages::IMidiMessageConverterStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall ConvertMidi1CompleteMessageBytesToUmpWords(void*, void*, bool, void**) noexcept = 0;
            virtual int32_t __stdcall ConvertSingleGroupCompleteMessageUmpWordsToMidi1Bytes(void*, void**) noexcept = 0;
            virtual int32_t __stdcall ConvertHexByteStringToByteArray(void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Microsoft_Windows_Devices_Midi2_Messages_IMidiMessageConverterStatics
    {
        ...
        auto ConvertMidi1CompleteMessageBytesToUmpWords(winrt::Microsoft::Windows::Devices::Midi2::MidiGroup const& group, param::iterable<uint8_t> const& midi1Bytes, bool allowRunningStatus) const;
        auto ConvertSingleGroupCompleteMessageUmpWordsToMidi1Bytes(param::iterable<uint32_t> const& umpWords) const;
        auto ConvertHexByteStringToByteArray(param::hstring const& hexByteString) const;
    };
