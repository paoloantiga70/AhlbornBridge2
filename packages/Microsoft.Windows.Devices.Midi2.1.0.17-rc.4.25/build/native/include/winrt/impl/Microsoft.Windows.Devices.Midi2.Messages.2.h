...
WINRT_EXPORT namespace winrt::Microsoft::Windows::Devices::Midi2::Messages
{
    ...
    struct MidiMessageConverter
    {
        ...
        static auto ConvertMidi1CompleteMessageBytesToUmpWords(winrt::Microsoft::Windows::Devices::Midi2::MidiGroup const& group, param::iterable<uint8_t> const& midi1Bytes, bool allowRunningStatus);
        static auto ConvertSingleGroupCompleteMessageUmpWordsToMidi1Bytes(param::iterable<uint32_t> const& umpWords);
        static auto ConvertHexByteStringToByteArray(param::hstring const& hexByteString);
    };
    struct MidiMessageHelper
    {
        ...
        static auto GetNoteDisplayNameFromNoteIndex(uint8_t noteIndex);
        static auto GetNoteOctaveFromNoteIndex(uint8_t noteIndex);
        static auto GetNoteOctaveFromNoteIndex(uint8_t noteIndex, uint8_t middleCOctave);
        static auto GetPacketListFromWordList(uint64_t timestamp, param::iterable<uint32_t> const& words);
        static auto GetWordListFromPacketList(param::iterable<winrt::Microsoft::Windows::Devices::Midi2::IMidiUniversalPacket> const& messages);
    };
    ...
    {
        MidiUniversalSystemExclusiveMessageBuilder() = delete;
        static auto BuildIdentityRequest(uint64_t timestamp, winrt::Microsoft::Windows::Devices::Midi2::MidiUniversalSystemExclusiveChannel const& systemExclusiveChannel);
        static auto BuildIdentityRequestReply(uint64_t timestamp, winrt::Microsoft::Windows::Devices::Midi2::MidiDeclaredDeviceIdentity const& identity);
        static auto BuildWait(uint64_t timestamp);
        static auto BuildCancel(uint64_t timestamp);
        static auto BuildNAK(uint64_t timestamp);
        static auto BuildACK(uint64_t timestamp);
    };
}
#endif
